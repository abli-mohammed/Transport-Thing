...
<div class="container" style="width: 100%;">
    ...
    {
        echo "<div align='center' style='margin-top:100px'><h4>There is no thing, please add an delivery. 
    ...
    {
    echo
    "<div class='col-lg-4 col-md-6 request' style='width: 31%'><h4 class='h4_request'><img src='images/",$ligne['type_thing'],".png' class='img_request'>
